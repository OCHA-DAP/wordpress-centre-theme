...
<div class="page-body<?= $bg_color ?>">
    <div class="post-wrapper">
        <div class="search-tabs">
            <ul>
                <li <?= $pageTypeQ == 'any' ? 'class="active"' : '' ?>><a
                            href="<?= $current_url ?>/?s=<?= $searchQ ?>&post_type=any"
                            class="filter-search-by-post-type">All Results</a></li>
                <li <?= $pageTypeQ == 'post' ? 'class="active"' : '' ?>><a
                            href="<?= $current_url ?>/?s=<?= $searchQ ?>&post_type=post"
                            class="filter-search-by-post-type">Only News</a></li>
                <li <?= $pageTypeQ == 'page' ? 'class="active"' : '' ?>><a
                            href="<?= $current_url ?>/?s=<?= $searchQ ?>&post_type=page"
                            class="filter-search-by-post-type">Only Pages</a></li>
            </ul>
        </div>
